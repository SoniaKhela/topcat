...
namespace Catalogue.Data.Write
{
    ...
    public class RecordService : IRecordService
    {
        ...
        public RecordService(IDocumentSession db, IRecordValidator validator, IVocabularyService vocabService, ISqlContext sqlDb)
        {
            this.db = db;
    ...
    class when_updating_a_record
    {
        ...
        {
            var service = new RecordService(Mock.Of<IDocumentSession>(), Mock.Of<IRecordValidator>(),Mock.Of<IVocabularyService>(), Mock.Of<ISqlContext>());
    ...
    class when_upserting_a_record
    {
        ...
        public void should_store_valid_record_in_the_database()
        {
            ...
            var service = new RecordService(database, ValidatorStub(), Mock.Of<IVocabularyService>(), Mock.Of<ISqlContext>());
        ...
        {
            var database = Mock.Of<IDocumentSession>();
            var service = new RecordService(database, FailingValidatorStub(), Mock.Of<IVocabularyService>(), Mock.Of<ISqlContext>());
