...
(function() {
  ...
  module.factory('DevTimeRecordLoader', function(Record, $route, $q) {
    return function() {
      var d;
      d = $q.defer({
        lineno: 48,
      ...
      Record.get({
        id: '58fbee5e-58e6-4119-82cb-587ec383cb62'
      }, function(record) {
        return d.resolve(record);
      }, function() {
        return d.reject('Unable to fetch dev-time record');
      });
      return d.promise;
    };
  });
